"""Export helpers for solved-baseline manifest runs."""
...
def write_manifest_run_outputs(out_dir: Path, records: list[Any], summary: Any, warnings: list[str]) -> dict[str, Path]:
    paths = {
        "records": out_dir / "manifest_run_records.jsonl",
