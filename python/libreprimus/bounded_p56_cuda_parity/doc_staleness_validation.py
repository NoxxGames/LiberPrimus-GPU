...
def build_doc_staleness_validation(
    *, doc_staleness_validation_out: Path = DOC_STALENESS_VALIDATION_PATH, out_dir: Path = OUTPUT_DIR
    ...
    result = scan_repository(root=resolve(Path(".")), source_of_truth_path=STAGE5AB_SOURCE_OF_TRUTH_PATH, operational_file_map=OPERATIONAL_FILE_MAP_PATH)
    ...
    record = base_record(
        ...
        doc_staleness_source_of_truth=str(STAGE5AB_SOURCE_OF_TRUTH_PATH),
