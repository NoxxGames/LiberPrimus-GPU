"""Stage 5CS operator-decision readiness/options scaffold metadata."""
...
STAGE_ID = "stage-5cs"
STAGE_TITLE = (
    "Stage 5CS - Operator-decision readiness package and real-approval "
    "decision options scaffold, without execution"
)
PROMPT_TYPE = "codex_metadata_implementation"
SOURCE_PREVIOUS_STAGE = "stage-5cq"
SOURCE_PREVIOUS_COMMIT = "38a86af98a45fb9606e128800edbe27b01cde342"
SOURCE_DEEP_RESEARCH_STAGE = "stage-5cr"
SOURCE_DEEP_RESEARCH_REPORT = "24_Stage-5CQ-Deep-Research-Review.md"
STAGE5CR_REPORT_PATH = Path(
    "deep-research-reports/reviews-of-ideas-and-concepts-and-data/md/"
    "24_Stage-5CQ-Deep-Research-Review.md"
)
RESULTS_DIR = Path("experiments/results/token-block/stage5cs")
CODEX_COMPLETION_PATH = Path("codex-output/stage5cs-codex-completion.md")
...
PYTEST_COUNT_OBSERVED_LOCALLY = 2423
...
STAGE5CR_FINDINGS = [
    "stage5cq_metadata_only_governance_stage_is_coherent",
    "stage5cq_operator_decision_scaffold_is_scaffold_only",
    "stage5cq_created_no_real_operator_decision",
    "stage5cq_created_no_real_operator_approval",
    "stage5cq_created_no_real_deep_research_activation_acceptance",
    "stage5cq_did_not_satisfy_combined_gate",
    "stage5cq_did_not_authorize_activation",
    "stage5cq_did_not_select_active_planning_input",
    "stage5cq_preserved_stage5co_readiness_package",
    "stage5cq_preserved_stage5bd_ten_run_plan_ids",
    "stage5cq_preserved_eight_record_active_lineage",
    "stage5cq_preserved_corrected_stage5aw_path",
    "stage5cq_kept_string4_scaffolded_inactive",
    "stage5cq_kept_no_active_no_byte_no_execution_boundaries_closed",
    "stage5cq_completion_summary_handoff_is_local_ignored_support",
    "public_github_ci_corroboration_is_external_caveat",
    "final_commit_and_ci_external_evidence_by_design",
    "credential_redaction_policy_requires_continued_audit",
    "next_safe_step_is_operator_decision_readiness_options_scaffold",
]
...
REVIEWABILITY_GAPS = [
    {
        ...
        "gate_opening": False,
        "severity": "medium",
        "status": "integrated_as_warning_stage5cs_preserves_handoff_continuity",
    },
    {
...
OPERATOR_DECISION_READINESS_REQUIREMENTS = [
    "stage5cr_review_findings_integrated",
...
DATA_PATHS: dict[str, Path] = {
    "summary": Path("data/project-state/stage5cs-summary.yaml"),
    "next_stage": Path("data/project-state/stage5cs-next-stage-decision.yaml"),
    "findings": Path("data/project-state/stage5cs-stage5cr-findings-integration.yaml"),
    "stage_marker": Path("data/project-state/stage5cs-reviewable-stage-marker.yaml"),
    "validation_evidence": Path("data/project-state/stage5cs-reviewable-validation-evidence.yaml"),
    "gap_register": Path("data/project-state/stage5cs-reviewability-gap-register.yaml"),
    "source_digest_index": Path("data/project-state/stage5cs-reviewable-source-digest-index.yaml"),
    "equivalence_map": Path("data/project-state/stage5cs-record-family-name-equivalence-map.yaml"),
    "operator_decision_readiness": Path(
        "data/token-block/stage5cs-operator-decision-readiness-package.yaml"
    ),
    "decision_options": Path(
        "data/token-block/stage5cs-real-approval-decision-options-scaffold.yaml"
    ),
    "options_nonselection": Path(
        "data/token-block/stage5cs-operator-options-nonselection-proof.yaml"
    ),
    "operator_decision_nonauthorization": Path(
        "data/token-block/stage5cs-operator-decision-nonauthorization-proof.yaml"
    ),
    "combined_gate_nonsatisfaction": Path(
        "data/token-block/stage5cs-combined-gate-non-satisfaction-proof.yaml"
    ),
    "activation_nonauthorization": Path(
        "data/token-block/stage5cs-activation-decision-nonauthorization-proof.yaml"
    ),
    "real_record_blocker": Path("data/token-block/stage5cs-real-record-creation-blocker.yaml"),
    "stage5cq_scaffold_preservation": Path(
        "data/token-block/stage5cs-stage5cq-operator-decision-scaffold-preservation.yaml"
    ),
    "stage5co_readiness_package": Path(
        "data/token-block/stage5cs-stage5co-readiness-package-preservation.yaml"
    ),
    "stage5co_missing_requirements": Path(
        "data/token-block/stage5cs-stage5co-missing-requirements-preservation.yaml"
    ),
    "stage5co_transition_plan": Path(
        "data/token-block/stage5cs-stage5co-transition-plan-preservation.yaml"
    ),
    "stage5cm_boundary": Path("data/token-block/stage5cs-stage5cm-boundary-preservation.yaml"),
    "stage5ck_preservation": Path("data/token-block/stage5cs-stage5ck-fixture-preservation.yaml"),
    "stage5ci_preservation": Path("data/token-block/stage5cs-stage5ci-template-preservation.yaml"),
    "stage5cg_preservation": Path("data/token-block/stage5cs-stage5cg-scaffold-preservation.yaml"),
    "stage5ce_preservation": Path(
        "data/token-block/stage5cs-stage5ce-proposal-package-preservation.yaml"
    ),
    "stage5cc_preservation": Path("data/token-block/stage5cs-stage5cc-contract-preservation.yaml"),
    "stage5bd_preservation": Path("data/token-block/stage5cs-stage5bd-plan-preservation.yaml"),
    "active_lineage": Path("data/token-block/stage5cs-active-lineage-preservation.yaml"),
    "no_active_ingestion": Path("data/token-block/stage5cs-no-active-ingestion-proof.yaml"),
    "no_byte_stream_transition_gate": Path(
        "data/token-block/stage5cs-no-byte-stream-transition-gate.yaml"
    ),
    "no_execution_transition_gate": Path(
        "data/token-block/stage5cs-no-execution-transition-gate.yaml"
    ),
    "supersession_nonactivation": Path(
        "data/token-block/stage5cs-manifest-supersession-nonactivation-proof.yaml"
    ),
    "sidecar_activation_blocker": Path("data/token-block/stage5cs-sidecar-activation-blocker.yaml"),
    "handoff": Path("data/source-harvester/stage5cs-codex-handoff-policy.yaml"),
    "completion_continuity": Path(
        "data/source-harvester/stage5cs-completion-summary-continuity.yaml"
    ),
    "credential_redaction": Path(
        "data/source-harvester/stage5cs-credential-redaction-policy-preservation.yaml"
    ),
    "review_packaging_warning": Path(
        "data/source-harvester/stage5cs-review-packaging-warning.yaml"
    ),
    "guardrail": Path("data/historical-route/stage5cs-guardrail.yaml"),
    "dwh": Path("data/historical-route/stage5cs-dwh-quarantine-reaffirmation.yaml"),
    "source_gap": Path("data/historical-route/stage5cs-source-gap-severity-update.yaml"),
}
...
RECORD_TYPES = {key: f"stage5cs_{key}" for key in DATA_PATHS}
...
def _completion_status() -> dict[str, Any]:
    return {
        ...
        "stage5cr_completion_summary_warning_integrated": True,
...
def _write_local_completion_summary_stub() -> None:
    ...
    if not CODEX_COMPLETION_PATH.exists():
        CODEX_COMPLETION_PATH.write_text(
            "\n".join(
                [
                    "# Stage 5CS Codex Completion Summary",
                    "",
                    "Status: local ignored handoff initialized by build-stage5cs.",
                    f"Starting commit: {SOURCE_PREVIOUS_COMMIT}",
                    "Stage 5CR verdict: accept_with_warnings",
...
def _validation_commands() -> list[dict[str, str]]:
    commands = [
        ...
        "python -m libreprimus.cli token-block stage5cs-summary",
...
def _build_records() -> dict[str, dict[str, Any]]:
    ...
    source_records = [
        _sha_record(path, role="stage5cs_reviewable_source") for path in _source_paths()
    ]
    ...
    records["findings"] = _record(
        "findings",
        {
            "stage5cr_findings_integrated": True,
            "stage5cr_verdict": "accept_with_warnings",
            "finding_count": len(STAGE5CR_FINDINGS),
            "findings": STAGE5CR_FINDINGS,
            "stage5cr_did_not_recommend_execution": True,
            "stage5cr_warning_count": len(REVIEWABILITY_GAPS),
        },
    )
    ...
    records["handoff"] = _record(
        "handoff",
        {
            ...
            "codex_output_used": False,
            "codex_completion_summary_committed": False,
            "stage5cs_codex_completion_summary_required": True,
            "stage5cs_codex_completion_summary_path": CODEX_COMPLETION_PATH.as_posix(),
            "stage5cs_codex_completion_summary_written_locally_before_final_response": (
    ...
    records["completion_continuity"] = _record(
        ...
        {
            "completion_summary_continuity_status": "preserved_for_stage5cs",
            "stage5cr_completion_summary_warning_integrated": True,
            "stage5cs_codex_completion_summary_required": True,
            "stage5cs_codex_completion_summary_path": CODEX_COMPLETION_PATH.as_posix(),
            "stage5cs_codex_completion_summary_written_locally_before_final_response": (
    ...
    records["credential_redaction"] = _record(
        "credential_redaction",
        {
            ...
            "committed_stage5cs_metadata_secret_scan_required": True,
            "secret_values_printed_or_committed": False,
    ...
    records["validation_evidence"] = _record(
        "validation_evidence",
        {
            ...
            "parallel_worker_cap_for_stage5cs_and_later": PARALLEL_WORKER_CAP,
    ...
    records["equivalence_map"] = _record(
        "equivalence_map",
        {
            ...
            "families": [
                {
                    "family_id": "stage5cs_operator_decision_readiness_records",
                    "equivalent_prefixes": [
                        "stage5cs-operator-decision-readiness",
                        "stage5cs-operator-decision-nonauthorization",
                    ],
                },
                {
                    "family_id": "stage5cs_decision_options_records",
                    "equivalent_prefixes": [
                        "stage5cs-real-approval-decision-options",
                        "stage5cs-operator-options-nonselection",
                    ],
                },
                {
                    "family_id": "stage5cs_real_record_blocker_records",
                    "equivalent_prefixes": [
                        "stage5cs-real-record-creation-blocker",
                        "stage5cs-combined-gate",
                        "stage5cs-activation-decision",
                    ],
                },
                {
                    "family_id": "stage5cs_stage5cq_preservation_records",
                    "equivalent_prefixes": [
                        "stage5cs-stage5cq-operator-decision",
                    ],
                },
                {
                    "family_id": "stage5cs_stage5co_preservation_records",
                    "equivalent_prefixes": [
                        "stage5cs-stage5co-readiness",
                        "stage5cs-stage5co-missing",
                        "stage5cs-stage5co-transition",
                    ],
                },
                {
                    "family_id": "stage5cs_prior_stage_preservation_records",
                    "equivalent_prefixes": [
                        "stage5cs-stage5cm",
                        "stage5cs-stage5ck",
                        "stage5cs-stage5ci",
                ...
                {
                    "family_id": "stage5cs_gate_records",
                    "equivalent_prefixes": [
                        "stage5cs-no-active-ingestion",
                        "stage5cs-no-byte-stream",
                        "stage5cs-no-execution",
                    ],
                },
                {
                    "family_id": "stage5cs_handoff_records",
                    "equivalent_prefixes": [
                        "stage5cs-codex-handoff",
                        "stage5cs-completion-summary",
                        "stage5cs-credential-redaction",
                    ],
                },
            ],
        },
    ...
    next_title = (
        "Stage 5CT - Deep Research review of Stage 5CS operator-decision readiness "
        "package and real-approval decision options scaffold, without execution"
    )
    records["next_stage"] = _record(
        "next_stage",
        {
            "selected_next_stage_id": "stage-5ct",
            ...
            "reason": (
                "Stage 5CS creates a readiness package and unselected decision-options "
                "scaffold; independent review is required before any future real "
                "operator decision, real approval record, activation decision, "
                "active-planning-input selection, byte-stream stage, or execution-adjacent stage."
            ),
        },
    )
    ...
    records["summary"] = _record(
        "summary",
        {
            ...
            "operator_decision_package_status": "not_created_in_stage5cs",
            "real_approval_records_created": False,
            "future_real_records_created_now": False,
            "combined_approval_gate_satisfied_now": False,
            "activation_decision_valid_now": False,
            ...
            "parallel_worker_cap_for_stage5cs_and_later": PARALLEL_WORKER_CAP,
            "future_token_block_execution_remains_blocked": True,
            "recommended_next_stage_id": "stage-5ct",
...
def build_stage5cs(*, results_dir: Path = RESULTS_DIR) -> dict[str, Any]:
    """Build Stage 5CS committed metadata and ignored reviewability reports."""
...
def _check_no_stage5cs_metadata_secrets(errors: list[str]) -> None:
    for path in DATA_PATHS.values():
        if path.is_file() and _path_has_secret_like_text(path):
            errors.append(f"credential_like_text_in_stage5cs_metadata={repo_relative(path)}")


def validate_stage5cs_actual_record_rejection(payload: dict[str, Any]) -> list[str]:
    errors: list[str] = []
...
def validate_stage5cs_stage5cr_findings(
    *, findings: Path = DATA_PATHS["findings"]
) -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    payload = _validate_payload(findings, errors)
    if payload.get("stage5cr_verdict") != "accept_with_warnings":
        errors.append("Stage 5CR verdict must be accept_with_warnings")
    observed = set(payload.get("findings", []))
    for item in sorted(set(STAGE5CR_FINDINGS) - observed):
        errors.append(f"missing_stage5cr_finding={item}")
    return {
        "stage5cs_stage5cr_findings_valid": not errors,
        "stage5cr_verdict": payload.get("stage5cr_verdict"),
        "finding_count": len(observed),
        "validation_error_count": len(errors),
    }, errors


def validate_stage5cs_operator_decision_readiness(
    *, operator_decision_readiness: Path = DATA_PATHS["operator_decision_readiness"]
    ...
    errors.extend(validate_stage5cs_actual_record_rejection(payload))
    return {
        "stage5cs_operator_decision_readiness_valid": not errors,
...
def validate_stage5cs_decision_options(
    *, decision_options: Path = DATA_PATHS["decision_options"]
    ...
    errors.extend(validate_stage5cs_actual_record_rejection(payload))
    return {
        "stage5cs_decision_options_valid": not errors,
        "operator_decision_option_count": payload.get("operator_decision_option_count"),
        "validation_error_count": len(errors),
    }, errors


def validate_stage5cs_options_nonselection(
    *, options_nonselection: Path = DATA_PATHS["options_nonselection"]
    ...
    errors.extend(validate_stage5cs_actual_record_rejection(payload))
    return {
        "stage5cs_options_nonselection_valid": not errors,
...
def validate_stage5cs_real_record_blocker(
    *, real_record_blocker: Path = DATA_PATHS["real_record_blocker"]
    ...
    errors.extend(validate_stage5cs_actual_record_rejection(payload))
    return {
        "stage5cs_real_record_blocker_valid": not errors,
...
def validate_stage5cs_combined_gate(
    *, combined_gate: Path = DATA_PATHS["combined_gate_nonsatisfaction"]
    ...
    for field in (
        ...
        if payload.get(field) is not False:
            errors.append(f"{field} must be false")
    return {
        "stage5cs_combined_gate_valid": not errors,
...
def validate_stage5cs_activation_nonauthorization(
    *, activation: Path = DATA_PATHS["activation_nonauthorization"]
    ...
    for field in (
        ...
        if payload.get(field) is not False:
            errors.append(f"{field} must be false")
    return {
        "stage5cs_activation_nonauthorization_valid": not errors,
        "activation_decision_valid_now": payload.get("activation_decision_valid_now"),
        "validation_error_count": len(errors),
    }, errors


def validate_stage5cs_stage5cq_preservation() -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    ...
    return {
        "stage5cs_stage5cq_preservation_valid": not errors,
...
def validate_stage5cs_stage5co_preservation() -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    ...
    return {
        "stage5cs_stage5co_preservation_valid": not errors,
...
def validate_stage5cs_prior_stage_preservation() -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    payloads = _load_all_payloads(errors)
    required_true = {
        "stage5cm_boundary": [
    ...
    for label, validator in (
        ...
        errors.extend(f"{label}:{error}" for error in validator_errors)
    return {
        "stage5cs_prior_stage_preservation_valid": not errors,
...
def validate_stage5cs_sidecar_gates() -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    payloads = {
    ...
    return {
        "stage5cs_sidecar_gates_valid": not errors,
...
def validate_stage5cs_handoff_continuity() -> tuple[dict[str, Any], list[str]]:
    errors: list[str] = []
    ...
    if continuity.get("stage5cs_codex_completion_summary_required") is not True:
        errors.append("Stage 5CS completion summary must be required")
    ...
    return {
        "stage5cs_handoff_continuity_valid": not errors,
        "stage5cs_codex_completion_summary_written_locally": CODEX_COMPLETION_PATH.is_file(),
        "codex_output_used": handoff.get("codex_output_used"),
        "validation_error_count": len(errors),
    }, errors


def validate_stage5cs_credential_redaction_policy(
    *, credential_redaction: Path = DATA_PATHS["credential_redaction"]
    ...
    for field in (
        ...
        "committed_stage5cs_metadata_secret_scan_required",
    ):
        if payload.get(field) is not True:
            errors.append(f"{field} must be true")
    ...
    _check_no_stage5cs_metadata_secrets(errors)
    return {
        "stage5cs_credential_redaction_policy_valid": not errors,
...
def validate_stage5cs(
    *,
    ...
    if summary_payload.get("stage5cr_verdict") != "accept_with_warnings":
        errors.append("summary Stage 5CR verdict must be accept_with_warnings")
    ...
    if summary_payload.get("parallel_worker_cap_for_stage5cs_and_later") != PARALLEL_WORKER_CAP:
        errors.append("Stage 5CS parallel worker cap must be 8")
    if next_payload.get("selected_next_stage_id") != "stage-5ct":
        errors.append("Stage 5CS must select Stage 5CT as next stage")
    if next_payload.get("selected_next_prompt_type") != "deep_research_review":
        errors.append("Stage 5CT prompt type must be deep_research_review")
    if next_payload.get("selected_next_stage_authorizes_execution") is not False:
        errors.append("Stage 5CT must not authorize execution")
    ...
    return {
        "stage5cs_valid": not errors,
        "validation_error_count": len(errors),
        "stage5cr_verdict": summary_payload.get("stage5cr_verdict"),
        ...
        "parallel_worker_cap": summary_payload.get("parallel_worker_cap_for_stage5cs_and_later"),
        "recommended_next_stage_id": summary_payload.get("recommended_next_stage_id"),
    }, errors


def load_stage5cs_summary(*, summary: Path = DATA_PATHS["summary"]) -> dict[str, Any]:
