...
from libreprimus.consistency.check_discord_full_review import check_discord_full_review_consistency
from libreprimus.consistency.check_post_discord import check_post_discord_consistency
...
CHECK_GROUPS = {
    ...
    "discord_full_review": check_discord_full_review_consistency,
