...
def check_docs_consistency(
    *,
    ...
    _require(results, "readme_stage3g", "Stage 3G" in readme and "complete" in readme.lower(), "README mentions Stage 3G complete.", readme_path)
    _require(results, "readme_stage3h", "Stage 3H" in readme and "complete" in readme.lower(), "README mentions Stage 3H complete.", readme_path)
    ...
    _require(results, "readme_stage3m", "Stage 3M" in readme and "complete" in readme.lower(), "README mentions Stage 3M complete.", readme_path)
    _require(results, "readme_stage3n_next", "Stage 3N" in readme, "README points to Stage 3N.", readme_path)
    _require(results, "readme_stage3o", "Stage 3O" in readme and "complete" in readme.lower(), "README mentions Stage 3O complete.", readme_path)
    _require(results, "readme_stage3p", "Stage 3P" in readme and "complete" in readme.lower(), "README mentions Stage 3P complete.", readme_path)
    _require(results, "readme_stage3s", "Stage 3S" in readme and "complete" in readme.lower(), "README mentions Stage 3S complete.", readme_path)
    _require(results, "readme_stage3t", "Stage 3T" in readme and "complete" in readme.lower(), "README mentions Stage 3T complete.", readme_path)
    _require(results, "readme_stage3u", "Stage 3U" in readme and "complete" in readme.lower(), "README mentions Stage 3U complete.", readme_path)
    _require(results, "readme_stage3v", "Stage 3V" in readme and "complete" in readme.lower(), "README mentions Stage 3V complete.", readme_path)
    _require(results, "readme_stage3w", "Stage 3W" in readme and "complete" in readme.lower(), "README mentions Stage 3W complete.", readme_path)
    ...
    _require(results, "status_stage3g", "Stage 3G" in status, "STATUS mentions Stage 3G.", status_path)
    _require(results, "status_stage3h", "Stage 3H" in status, "STATUS mentions Stage 3H.", status_path)
    ...
    _require(results, "status_stage3m", "Stage 3M" in status, "STATUS mentions Stage 3M.", status_path)
    _require(results, "status_stage3n", "Stage 3N" in status, "STATUS mentions Stage 3N.", status_path)
    _require(results, "status_stage3o", "Stage 3O" in status, "STATUS mentions Stage 3O.", status_path)
    _require(results, "status_stage3p", "Stage 3P" in status, "STATUS mentions Stage 3P.", status_path)
    _require(results, "status_stage3s", "Stage 3S" in status, "STATUS mentions Stage 3S.", status_path)
    _require(results, "status_stage3t", "Stage 3T" in status, "STATUS mentions Stage 3T.", status_path)
    _require(results, "status_stage3u", "Stage 3U" in status, "STATUS mentions Stage 3U.", status_path)
    _require(results, "status_stage3v", "Stage 3V" in status, "STATUS mentions Stage 3V.", status_path)
    _require(results, "status_stage3w", "Stage 3W" in status, "STATUS mentions Stage 3W.", status_path)
    ...
    _require(results, "roadmap_stage3h", "Stage 3H" in roadmap, "ROADMAP mentions Stage 3H.", roadmap_path)
    _require(results, "roadmap_stage3i", "Stage 3I" in roadmap, "ROADMAP mentions Stage 3I.", roadmap_path)
    ...
    _require(results, "roadmap_stage3n", "Stage 3N" in roadmap, "ROADMAP mentions Stage 3N.", roadmap_path)
    _require(results, "roadmap_stage3o", "Stage 3O" in roadmap, "ROADMAP mentions Stage 3O.", roadmap_path)
    _require(results, "roadmap_stage3p", "Stage 3P" in roadmap, "ROADMAP mentions Stage 3P.", roadmap_path)
    _require(results, "roadmap_stage3q", "Stage 3Q" in roadmap, "ROADMAP mentions Stage 3Q.", roadmap_path)
    _require(results, "roadmap_stage3s", "Stage 3S" in roadmap, "ROADMAP mentions Stage 3S.", roadmap_path)
    _require(results, "roadmap_stage3t", "Stage 3T" in roadmap, "ROADMAP mentions Stage 3T.", roadmap_path)
    _require(results, "roadmap_stage3u", "Stage 3U" in roadmap, "ROADMAP mentions Stage 3U.", roadmap_path)
    _require(results, "roadmap_stage3v", "Stage 3V" in roadmap, "ROADMAP mentions Stage 3V.", roadmap_path)
    _require(results, "roadmap_stage3w", "Stage 3W" in roadmap, "ROADMAP mentions Stage 3W.", roadmap_path)
