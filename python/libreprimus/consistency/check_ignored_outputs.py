...
def check_ignored_output_consistency(root: Path = repo_root()) -> list[ConsistencyCheckResult]:
    ...
    ignored_paths = [
        ...
        "experiments/results/gematria-solved-fixture-cuda-repeat/stage5o/result_store_preflight_report.json",
        "experiments/results/gematria-solved-fixture-cuda-repeat/stage5o/score_summary_preflight_report.json",
        "experiments/results/gematria-solved-fixture-cuda-repeat/stage5o/expansion_decision_report.json",
        ...
        "experiments/results/cuda-candidate-batch-abi-conformance/stage5v/schedule_conformance_report.json",
        ...
        "experiments/results/cuda-candidate-batch-abi-conformance/stage5v/result_store_conformance_report.json",
        "experiments/results/cuda-candidate-batch-abi-conformance/stage5v/gap_closure_report.json",
        "experiments/results/cuda-candidate-batch-abi-conformance/stage5v/next_stage_decision.json",
        ...
        "experiments/results/prime-minus-one-native-reporting/stage5y/result_store_integration_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/score_summary_integration_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/method_status_impact_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/generated_body_policy_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/full_p56_blocker_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/cuda_contract_readiness_gate.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/scored_experiment_readiness_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/guardrail_report.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/next_stage_decision.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/summary.json",
        "experiments/results/prime-minus-one-native-reporting/stage5y/warnings.jsonl",
        ...
        "experiments/results/prime-minus-one-cuda-contract/stage5z/kernel_abi_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/host_runner_contract_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/buffer_contract_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/validation_vector_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/future_parity_plan_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/result_store_compatibility_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/full_p56_blocker_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/scored_experiment_deferral_report.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/implementation_readiness_gate.json",
        "experiments/results/prime-minus-one-cuda-contract/stage5z/next_stage_decision.json",
