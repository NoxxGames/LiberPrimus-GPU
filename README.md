...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5BM Deep Research findings integration and String 4 branch-crosswalk repair. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5BN - String 4 unsupported-position source-gap closure and human-review pack preparation, without execution.
...
- Latest historical-route/token-block crosswalk stage: Stage 5BM integrates Stage 5BL findings and String 4 branch-crosswalk metadata without execution. It records String 4 `partial_branch_match`, positions checked `256`, canonical matches `249`, Stage 5AW-supported noncanonical positions `6`, unsupported positions `1`, parser-inconclusive positions `0`, canonical transcription changed `false`, active token-block manifests changed `false`, and Stage 5BN source-gap closure/human-review pack preparation as next.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5BM updates current/next-stage records to Stage 5BN.
- Next: Stage 5BN - String 4 unsupported-position source-gap closure and human-review pack preparation, without execution.
