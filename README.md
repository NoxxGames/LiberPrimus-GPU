...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 3K and the work that must stay bounded, reviewable, and reproducible before larger experiments begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 3L deterministic image/audio/web analysis CLIs or a cookie-hash bounded preimage pack after Stage 3K registry review.
...
- Next: Stage 3L deterministic image/audio/web analysis CLIs or cookie-hash bounded preimage pack after registry review.
