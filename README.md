...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5BF historical route source-lock and technique extraction. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5BG - Deep Research review of historical route source-lock, technique taxonomy, and token-block planning impact.
...
- Latest historical-route stage: Stage 5BF source-locks the local `third_party/CicadaSolversIddqd` 2012-2017 route archive as metadata only. It records archive files `1243`, archive size `838987564`, high-priority artefacts `1043`, PGP candidates `96`, stego candidates `80`, OutGuess candidates `61`, OpenPuff/MP3 candidates `7`, magic-square artefacts `7`, hex/JPEG candidates `595`, onion artefacts `293`, book-code artefacts `14`, network-byte-channel artefacts `12`, Liber Primus historical artefacts `257`, source gaps `4`, archive tree digest `bdc8739120be85fc7015e495704ee80bc80ef3a25cfc32c43e3b4d7de40270af`, and Stage 5BG Deep Research review as next.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5BF updates current/next-stage records to Stage 5BG.
- Next: Stage 5BG - Deep Research review of 2012-2017 historical route source-lock, technique taxonomy, and impact on future token-block dry-run planning.
