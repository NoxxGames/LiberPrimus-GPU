...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5DQ Operator Console v0 Source-Browser GUI implementation. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5DR updates current/next-stage records to Stage 5DR complete and Stage 5DS next.
- Next: Stage 5DS - Operator Console source-review readiness planning, without puzzle execution.
