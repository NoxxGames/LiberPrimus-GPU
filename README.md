...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5BU Stage 5BS lineage-path and reviewability hardening. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5BV - Deep Research review of Stage 5BU lineage-path and reviewability hardening, without execution.
...
- Stage 5BU Stage 5BS lineage-path and reviewability hardening.
...
- Latest historical-route/token-block crosswalk stage: Stage 5BU consumes Stage 5BT findings as compact metadata, repairs the Stage 5BS preserved active-lineage path from `data/token-block/stage5aw-repaired-branch-manifest.yaml` to `data/token-block/stage5aw-repaired-token-variant-branch-manifest.yaml`, validates 8 preserved active-lineage paths, hardens Stage 5BS validation, and leaves the Stage 5BS String 4 gate closed with future token-block execution blocked.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5BU updates current/next-stage records to Stage 5BV.
- Next: Stage 5BV - Deep Research review of Stage 5BU lineage-path and reviewability hardening, without execution.
