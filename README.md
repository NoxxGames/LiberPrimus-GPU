...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5BS String 4 inactive-branch planning-ingestion gate and future-runner citation integration. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5BT - Deep Research review of Stage 5BS planning-ingestion gate and reviewable evidence metadata.
...
- Latest historical-route/token-block crosswalk stage: Stage 5BS consumes Stage 5BR findings as compact metadata, records the Stage 5BO/5BQ String 4 `full_branch_match` as inactive sidecar context only, creates a closed planning-ingestion gate plus fail-closed future-runner citation policy, preserves Stage 5AP/5AW/5AY/5AZ/5BB/5BD records unchanged, keeps Stage 5BD dry-run records valid, and leaves future token-block execution blocked.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5BS updates current/next-stage records to Stage 5BT.
- Next: Stage 5BT - Deep Research review of Stage 5BS planning-ingestion gate and reviewable evidence metadata.
