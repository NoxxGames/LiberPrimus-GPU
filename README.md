...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5U unified candidate batch ABI and backend contract consolidation. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5V - native candidate batch ABI reference adapter and conformance fixtures.
...
- Next: Deep Research - Stage 5M-5S CUDA parity arc project review and next-direction assessment.
