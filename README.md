...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5J Gematria mod-29 `shift_score` synthetic CUDA parity kernel implementation. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5K Gematria shift_score CUDA parity reporting and solved-fixture-safe preflight after Stage 5J parity.
...
- Next: Stage 5K Gematria shift_score CUDA parity reporting and solved-fixture-safe preflight.
