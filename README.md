...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5BW String 4 inactive-sidecar planning-ingestion proposal and manifest-supersession preflight. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Stage 5BX - Deep Research review of Stage 5BW inactive-sidecar planning-ingestion proposal and manifest-supersession preflight, without execution.
...
- Stage 5BW String 4 inactive-sidecar planning-ingestion proposal and manifest-supersession preflight.
...
- Stage 5BW: inactive-sidecar planning-ingestion proposal, manifest-supersession preflight, active-lineage preservation, and Stage 5BD run-plan preservation complete.
...
- Latest historical-route/token-block crosswalk stage: Stage 5BW consumes Stage 5BV findings as compact metadata, proposes future inactive-sidecar planning-ingestion semantics, creates manifest-supersession preflight records without superseding active manifests, preserves 8 active-lineage paths and 10 Stage 5BD run-plan IDs, and leaves String 4 active input, dry-run ingestion, byte-stream generation, and future token-block execution blocked.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5BW updates current/next-stage records to Stage 5BX.
- Next: Stage 5BX - Deep Research review of Stage 5BW inactive-sidecar planning-ingestion proposal and manifest-supersession preflight, without execution.
