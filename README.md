...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5DX source-lock number-fact review batch 002. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5DX updates current/next-stage records to Stage 5DX complete and Stage 5DY next.
- Next: Stage 5DY - Operator/assistant source-lock number-fact review batch 3, without execution.
