...
These are not permanent project exclusions unless marked as safety rules. They describe the current implementation boundary after Stage 5EB validation finalization and 10-worker policy repair. Future experiments must stay bounded, reviewable, and reproducible before larger campaigns begin. CUDA and broad campaigns are deferred, not permanently excluded.
...
- Latest doc-staleness stage: Stage 5AH repairs README stage-ledger coverage, operational-file-map coverage, and current/next-stage consistency checks before curated extraction. Stage 5EB updates current/next-stage records to Stage 5EB complete and Stage 5EC next.
...
- Next: Stage 5EC - Operator/assistant source-lock number-fact review batch 3, without execution.
