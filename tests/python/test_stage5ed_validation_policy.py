...
def test_stage5ed_records_full_parallel_as_normal_final_profile() -> None:
    ensure_stage5ed_built()
    evidence = load_yaml("data/project-state/stage5ed-reviewable-validation-evidence.yaml")
