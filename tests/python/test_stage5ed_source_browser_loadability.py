...
from libreprimus.token_block.stage5ed import validate_stage5ed_source_browser_loadability
from test_stage5ed_common import ensure_stage5ed_built, load_yaml


def test_stage5ed_source_browser_loadability_has_zero_errors() -> None:
    ensure_stage5ed_built()
    result = validate_stage5ed_source_browser_loadability()
    summary = load_yaml("data/project-state/stage5ed-source-browser-loadability-summary.yaml")
