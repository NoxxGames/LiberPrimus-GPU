...
from libreprimus.token_block.stage5ea import DATA_PATHS, SCHEMA_BY_DATA_KEY, SCHEMA_PATHS
from test_stage5ea_common import ensure_stage5ea_built, load_yaml


def test_stage5ea_schemas_validate_records() -> None:
...
def test_stage5ea_summary_schema_fails_closed_on_guardrails() -> None:
    ensure_stage5ea_built()
