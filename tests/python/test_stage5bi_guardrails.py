...
def test_stage5bi_guardrails_preserve_no_execution_boundary() -> None:
    payload = load_yaml("data/historical-route/stage5bi-guardrail.yaml")

    assert payload["metadata_only"] is True
    assert payload["historical_source_lock_triage_only"] is True
