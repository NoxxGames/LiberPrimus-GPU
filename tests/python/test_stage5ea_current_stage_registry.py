...
def test_current_stage_registry_preserves_stage5ea_or_newer_stage() -> None:
    ...
    if state["latest_completed_stage_id"] == "stage-5ea":
    ...
    elif state["latest_completed_stage_id"] == "stage-6c":
    ...
    elif state["latest_completed_stage_id"] == "stage-6d":
        assert state["recommended_next_stage_id"] == "stage-6e"
        assert current_latest_stage_label() == "Stage 6D"
        assert current_next_stage_label() == "Stage 6E"
        assert current_latest_stage_command_suffix() == "stage6d"
    elif state["latest_completed_stage_id"] == "stage-6e":
        assert state["recommended_next_stage_id"] == "stage-6f"
    ...
    elif state["latest_completed_stage_id"] == "stage-6g":
        ...
        assert state["recommended_next_stage_id"] == "stage-6i"
        assert current_latest_stage_label() == "Stage 6H"
        assert current_next_stage_label() == "Stage 6I"
        assert current_latest_stage_command_suffix() == "stage6h"
