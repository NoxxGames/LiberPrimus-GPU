...
def test_stage5ec_overlay_only_fact_cards_render_for_zero_extracted_fact_entry() -> None:
    entry = SourceBrowserEntry(
        entry_id="stage5ec-test-entry",
        entry_type="source_lock",
        category="Number facts",
        title="Stage 5EC test entry",
        summary="test",
        stage_id="stage-5ec",
        record_type="stage5ec_test",
        ...
        source_record_path="data/historical-route/stage5ec-test-entry.yaml",
        number_facts=[],
    )
    overlay = {
        "record_type": "source_browser_number_fact_enrichment_overlay",
        "overlay_id": "stage5ec_overlay_only_test",
...
def test_stage5ec_overlay_collection_requires_overlay_only_cards() -> None:
