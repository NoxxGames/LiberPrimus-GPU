...
def test_stage5ec_records_full_parallel_as_normal_final_profile() -> None:
    ensure_stage5ec_built()
    evidence = load_yaml("data/project-state/stage5ec-reviewable-validation-evidence.yaml")
