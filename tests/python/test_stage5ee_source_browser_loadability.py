...
from libreprimus.token_block.stage5ee import validate_stage5ee_source_browser_loadability
from test_stage5ee_common import ensure_stage5ee_built, load_yaml


def test_stage5ee_source_browser_loadability_has_zero_errors() -> None:
    ensure_stage5ee_built()
    result = validate_stage5ee_source_browser_loadability()
    summary = load_yaml("data/project-state/stage5ee-source-browser-loadability-summary.yaml")
