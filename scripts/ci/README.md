...
- `run-consistency-checks.ps1` / `run-consistency-checks.sh`: schema, manifest, docs, registry, ignored-output, result-store, Stage 2E exploratory dry-run, and Stage 2F bounded CPU execution consistency checks.
