...
The build command reads committed Stage 5AL metadata and writes the generated site under `website-export/stage5am/research-index/`. `validate-stage5am-site` checks an ignored generated site when present; `validate-stage5am` validates committed records and treats missing ignored site/report files as optional so CI does not require generated outputs.
