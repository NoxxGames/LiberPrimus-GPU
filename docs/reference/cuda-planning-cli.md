...
- `validate-stage5a`: validates schemas, counts, guardrail flags, target/scaffold consistency, generated summary parity via `--results-dir`, and non-target coverage.
