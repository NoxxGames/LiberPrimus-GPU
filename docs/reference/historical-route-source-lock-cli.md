...
Stage 5BW reaffirms historical-route DWH quarantine and source-gap guardrails while proposing inactive-sidecar planning ingestion for future review; it adds no historical-route execution command and does not authorize DWH/hash search.
