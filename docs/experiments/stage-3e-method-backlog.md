...
The Stage 3E backlog started with six candidate method families. Stage 3G added one future low-cost probe, and Stage 3J later promoted that probe to runnable:
...
- `stage3i_mersenne_prime_stream_tiny_v1`: Mersenne/perfect-number stream probe, `192` candidates, runnable through the Stage 3J executor.

Total deterministic candidate estimate after Stage 3J: `972`.
