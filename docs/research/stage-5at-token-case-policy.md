# Stage 5AT Token Case Policy

Stage 5AT keeps token-case handling in human-review state. The active ambiguity classes are `I/l`, `O/0`, `1/I/l`, `S/5`, `Z/2`, `B/8`, `G/6`, `o/0`, and `q/g/p`.
