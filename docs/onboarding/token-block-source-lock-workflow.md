...
2. Inspect the committed Stage 5AP records under `data/token-block/` and `data/stego/`, then inspect the Stage 5AR coordinate records under `data/token-block/stage5ar-*`.
...
Generated Stage 5AP reports live under `experiments/results/token-block/stage5ap/` and `experiments/results/stego-controls/stage5ap/`; generated Stage 5AR coordinate reports live under `experiments/results/token-block/stage5ar/`. They remain ignored except README/.gitkeep scaffolds.
