...
Stage 5AX inserted parallel validation infrastructure after this repair. Bounded token-block preflight design is now Stage 5AY and must cite the repaired Stage 5AW branch manifest.
