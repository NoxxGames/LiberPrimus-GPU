...
Stage 5CW selects Stage 5CX Deep Research review as the next prompt. Use `data/project-state/stage5cw-*`, `data/token-block/stage5cw-*`, `data/historical-route/stage5cw-*`, `data/source-harvester/stage5cw-*`, then the preserved Stage 5CU, Stage 5CS, Stage 5CQ, Stage 5CO, Stage 5CM, Stage 5CK, Stage 5CI, Stage 5CG, Stage 5CE, Stage 5CC, and Stage 5BD records. Ignored generated reports under `experiments/results/token-block/stage5cw/` and ignored local completion summaries under `codex-output/` are generated aids, not source truth or public publication. Do not hand Deep Research raw `third_party/` paths, iddqd-v2 raw bodies, Fandom HTML/images, spreadsheet bodies, decision-template bodies, full extracted 2014 surface bodies, decoded bytes, fonts, media, or raw page images as source truth. Public website expansion remains a future review-gated project.
