...
Use the Stage 5AL export package, Stage 5AM static index metadata, Stage 5AN private content-pack metadata, Stage 5AP token-block source-lock records, Stage 5AR coordinate-lock records, and Stage 5AT review-pack metadata as the private handoff layer for future review work. They summarize Stage 5AI bundles, Stage 5AJ UsefulFiles metadata, Stage 5AK community-facts claim metadata, and page 49-51 token-block/coordinate/case-review preflight records behind publication gates.
