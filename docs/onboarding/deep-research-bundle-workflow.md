...
Use Stage 5AI bundles, Stage 5AJ UsefulFiles metadata, and Stage 5AK community-facts claim metadata as the private handoff layer for the next Deep Research prompt.
...
Stage 5AL should evaluate source inventory and reliability from Stage 5AI/5AJ/5AK metadata. It should not
