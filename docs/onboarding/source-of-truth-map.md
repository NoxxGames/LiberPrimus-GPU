...
- `data/project-state/stage5ah-doc-staleness-source-of-truth.yaml`: active current/next-stage expectations for the document staleness checker; after Stage 5AJ it names Stage 5AJ as latest complete and Stage 5AK as next.
...
- `docs/onboarding/deep-research-bundle-workflow.md`: Stage 5AI/5AJ private Deep-Research bundle handoff workflow.
