...
- `source-harvester-output/`, `harvest-output/`, and `research-inputs/`: local Stage 5AF/5AG/5AI/5AJ/5AK source-harvester raw output roots. Store manually exported Google/Dropbox/Colab/community material locally here or in another ignored local root; do not use Google Drive as project storage.
...
- `human-review-packs/stage5au/`: generated local Stage 5AU token-case review-pack v2 files, glyph-candidate crops, context crops, row crops, overlays, review sheets, blank decision templates, HTML index, and ZIP archives. Commit only root `.gitkeep` scaffolds; generated review-pack bodies remain ignored.
- `human-review-packs/stage5au/token-case-review-v2/decision-template.yaml`: filled Stage 5AV human decision template, local and ignored. Commit only derived compact metadata under `data/token-block/stage5av-*` and Stage 5AW repaired compact metadata under `data/token-block/stage5aw-*`.
...
- `experiments/results/token-block/stage5aw/`: generated Stage 5AW decision-parser audit, repaired variant, malformed-fragment, repaired primary-60 impact, repaired branch-manifest, summary, and warning reports. Commit only `.gitkeep`; generated JSON reports remain ignored.
- `experiments/results/ci/parallel-validation/stage5ax/`: generated Stage 5AX parallel validation run summaries, command logs, failure records, timing records, pytest shard reports, and per-command stdout/stderr files. Commit only scaffolding under `experiments/results/ci/`; generated validation logs and JSON/JSONL reports remain ignored.
...
- `experiments/results/historical-route/stage5bf/`: generated Stage 5BF full archive inventory, high-priority artifact index JSON, source-gap reports, summaries, and warnings. Commit only README/.gitkeep scaffolding plus compact metadata under `data/historical-route/` and `data/project-state/`; generated reports remain ignored.
- `deep-research-content-packs/stage5bf/` and `deep-research-repo-zips/stage5bf/`: generated Stage 5BF Deep Research pack manifests, hashes, content packs, and future ZIPs. Commit only `.gitkeep` scaffolding; generated packs and ZIPs remain ignored.
...
- `experiments/results/token-block/stage5au/`: generated Stage 5AU usability-audit, review-pack v2, crop-quality, validation, summary, and warning reports. Commit only `.gitkeep` scaffolds.
- `experiments/results/token-block/stage5av/`: generated Stage 5AV decision-ingest, validation, decision-record, variant-branch, impact, summary, and warning reports. Commit only `.gitkeep` scaffolds.
...
- Generated Stage 5AR coordinate-lock reports under `experiments/results/token-block/stage5ar/`.
