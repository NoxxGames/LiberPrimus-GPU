...
Stage 5AL exports community-claim metadata to `data/website-ingest/stage5al/community-claims.yaml` without raw message bodies, formulas, claimed-values maps, private message locators, or attachment bodies. Stage 5AM renders only that metadata into the ignored private static research index and preserves the publication gate labels. Publication remains blocked/private until a future review stage changes the gate.
