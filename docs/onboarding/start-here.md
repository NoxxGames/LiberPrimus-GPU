...
- Latest completed stage: Stage 5AM - static research website renderer and webserver export package.
- Current planning focus: Stage 5AN - Deep Research source inventory and reliability prompt.
...
- Curated source bundles: Stage 5AI, Stage 5AJ, and Stage 5AK metadata is complete; Stage 5AL adds a metadata-only website-ingest package and private Deep Research export, and Stage 5AM renders that metadata to an ignored private static index. Generated bundle bodies, UsefulFiles extraction bodies, community-facts private addenda, Stage 5AL private export helpers, and Stage 5AM static site files stay ignored.
...
- Deep Research: read `docs/onboarding/deep-research-handoff-map.md`, `docs/onboarding/deep-research-bundle-workflow.md`, `docs/onboarding/deep-research-ingest-format.md`, and `docs/onboarding/community-observation-ingest-workflow.md`; use curated Stage 5AI/5AJ/5AK source-card, claim-record, Stage 5AL website-ingest, and Stage 5AM renderer metadata only.
