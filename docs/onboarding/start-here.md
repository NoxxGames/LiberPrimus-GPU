...
- Latest completed stage: Stage 5AF - Cicada source harvester and archive/visual/numeric provenance inventory tooling.
- Current planning focus: Stage 5AG - run source harvester on user-provided downloads and build initial source-lock inventory.
...
- Deep Research: read `docs/onboarding/deep-research-handoff-map.md` and use redacted/generated bundles only.
- Source harvester: read `docs/onboarding/source-harvester-workflow.md`; use local ignored output roots only and do not use Google Drive as project storage.
