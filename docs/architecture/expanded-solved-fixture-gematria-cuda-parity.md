...
Stage 5S follow-up: the Stage 5R parity rows are now integrated into compact parity-report,
result-store, score-summary, method-status, generated-body policy, boundary-review, and
next-step-decision records. Stage 5S does not rerun CUDA and does not publish generated result
bodies.
