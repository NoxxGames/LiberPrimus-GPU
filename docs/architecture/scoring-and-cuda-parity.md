...
Unknown score semantics are recorded as `scoring_not_available`, not inferred. Future CUDA score parity should compare against the unified Stage 4P result surface only after Stage 4O output hashes match.
