...
CUDA remains deferred until Stage 4I scorer consolidation, parity tests, and benchmark plans exist. Existing CUDA code remains scaffold/smoke infrastructure unless a later explicit stage says otherwise.
