...
Stage 5CO adds compact real approval-record readiness-package records, future operator approval/Deep Research acceptance/combined-gate/activation-decision preflight records, missing-requirements and transition-sequence records, Stage 5CM/5CK/5CI/5CG/5CE/5CC/5BD preservation records, no-active/no-byte/no-execution transition-gate records, credential-redaction preservation records, review-packaging-warning records, and source-digest/reviewability records only. It does not publish generated result bodies, byte streams, decoded bytes, score summaries, SQLite databases, local reports, actual approval decisions, actual activation decisions, or active String 4 inputs. Generated Stage 5CO diagnostics remain ignored under `experiments/results/token-block/stage5co/`.
