...
Stage 5DU does not change cipher-family status. It source-locks community visual/red-heading/negative-space thread material as compact metadata, records review-only candidate families and number-fact overlays, preserves Stage 5DT and active-lineage gates, keeps all targets unselected, and keeps String 4 inactive, non-executable, non-canonical, and non-solve-evidence.
